...
export class SeedDataService {
  ...
  private async seedProducts(
    cats: Record<string, { id: string; name: string }>
  ): Promise<SeedProduct[]> {
    const catalogue = [
      // ── REMERAS ────────────────────────────────────────────────────────────
      {
      ...
      // ── PANTALONES ─────────────────────────────────────────────────────────
      {
        ...
        colors: ['Azul índigo', 'Negro', 'Beige', 'Gris', 'Verde militar'],
        variants: ['talle', 'color'],
        items: [
          {
      ...
      // ── ZAPATILLAS ─────────────────────────────────────────────────────────
      {
        ...
        colors: ['Blanco/Negro', 'Negro total', 'Gris/Azul', 'Beige/Crema', 'Rojo/Blanco'],
        variants: ['talle', 'color'],
        items: [
          {
      ...
      // ── ACCESORIOS ─────────────────────────────────────────────────────────
      {
        slug: 'accesorios',
        talles: ['Único'],
        colors: ['Negro', 'Marrón', 'Azul navy', 'Beige', 'Oliva'],
        variants: ['color'],
        items: [
          {
      ...
      // ── CAMPERAS ───────────────────────────────────────────────────────────
      {
        slug: 'camperas',
        talles: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
        colors: ['Negro', 'Marrón', 'Caqui', 'Navy', 'Rojo'],
        variants: ['talle', 'color'],
        items: [
          {
  ...
  private async seedClients(): Promise<SeedClient[]> {
    const data: Omit<SeedClient, 'id'>[] = [
      ...
      { fullName: 'Camila López', email: 'camila.lopez@outlook.com', phone: '+54 9 11 4712-3345' },
      {
        ...
        phone: '+54 9 11 6789-2200',
      },
      {
        fullName: 'Lucía González',
        email: 'luci.gonzalez@yahoo.com.ar',
      ...
      {
        fullName: 'Martina Álvarez',
        email: 'marti.alvarez@outlook.com',
        phone: '+54 9 11 6645-2278',
      },
      ...
      {
        fullName: 'Benjamín Herrera',
        email: 'benja.herrera@gmail.com',
        phone: '+54 9 11 7712-0044',
      },
      { fullName: 'Milagros Castro', email: 'mili.castro@gmail.com', phone: '+54 9 11 3390-7789' },
      {
        fullName: 'Lautaro Vargas',
        email: 'lauta.vargas@hotmail.com',
        phone: '+54 9 11 5567-3312',
      },
      { fullName: 'Renata Medina', email: 'renata.medina@gmail.com', phone: '+54 9 11 4434-8856' },
      {
        fullName: 'Ezequiel Acosta',
        email: 'ezequiel.acosta@gmail.com',
        phone: '+54 9 11 6601-2245',
      },
    ];
