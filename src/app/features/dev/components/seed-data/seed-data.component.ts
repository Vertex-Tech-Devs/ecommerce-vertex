        ...
        <div class="seed-content">
          <div class="info-box">
            ...
            <ul>
              ...
              <li>
                ✓ Genera automáticamente todas las variantes (combinaciones de talles y colores)
              </li>
          ...
          <div class="warning-box">
            ...
            <div>
              ...
              <p>
                ...
                categorías, pedidos, clientes, atributos, banner, About y Footer) y los vuelve a
                crear desde cero con datos de prueba completos y consistentes.
              </p>
            </div>
          </div>
          ...
          <div class="action-buttons">
            <button (click)="onSeedData()" [disabled]="isLoading" class="btn btn-warning btn-lg">
          ...
          <div class="info-footer">
            <p>
              Las imágenes se obtienen de <strong>picsum.photos</strong> (licencia abierta). Todos
              los datos son ficticios y solo sirven para testing y demostración. No usar en
              producción.
            </p>
          </div>
        </div>
