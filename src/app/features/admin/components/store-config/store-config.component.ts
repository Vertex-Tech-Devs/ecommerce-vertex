...
export class StoreConfigComponent {
  ...
  private populateFormFromConfig(cfg: StoreConfig | null): void {
  ...
  private patchGeneralSettings(cfg: StoreConfig | null, currentTenant: string): void {
  ...
  private patchBrandingAndSocial(cfg: StoreConfig | null): void {
    this.form.patchValue({
      logoUrl: cfg?.logoUrl ?? '',
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      await this.storeConfigService.saveConfig(this.form.getRawValue() as unknown as StoreConfig);
