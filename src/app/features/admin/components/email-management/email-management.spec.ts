...
describe('EmailManagement', () => {
  let component: EmailManagement;
  let fixture: ComponentFixture<EmailManagement>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [EmailManagement, ReactiveFormsModule],
      providers: [
    ...
    fixture = TestBed.createComponent(EmailManagement);
