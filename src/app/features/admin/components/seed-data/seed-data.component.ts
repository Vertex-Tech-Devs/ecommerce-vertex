        ...
        <div class="seed-content">
          ...
          <div class="action-buttons">
            ...
            >
              ...
              {{ isLoading ? 'Generando datos...' : 'Generar Datos de Prueba' }}
            </button>
          ...
          <div class="info-footer">
            <p>
              <strong>Nota:</strong> Las imágenes se obtienen de Unsplash (licencia abierta).
              Los datos son completamente ficticios y solo para propose de testing.
            </p>
          </div>
        </div>
      </div>
